...
{{-- <div class="jumbotron">
  ...
  <p class="lead">Selamat datang di halaman <span><b>Bold Face 400</b></span></p>
...
<div class="card mb-4 mt-4">
  <div class="border-bottom-danger">
      ...
      <div class="ml-4 mt-2 mb-4 mt-4 text-center">
          <h3><b> DAFTAR YANG MENGERJAKAN BOLD FACE PROCEDURE NC-212i SERI 400 </b></h3>
      </div>
  </div>
</div>
                ...
                @foreach ($boldFaces as $key => $boldFace)
                  <tr>
                    ...
                    <td style="vertical-align: middle; text-align: center">
                      <a href="{{ route('bold.face.400.download-pdf', $boldFace->id)}}" class="btn btn-warning btn-icon-split mr-3" target="_blank">
