...
class SubmitBoldFaceS200Request extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'premise_4_5' => 'required|string',
            'answer_4_5' => 'required|string',
            'premise_4_6' => 'required|string',
            'answer_4_6' => 'required|string',
            ...
            'answer_7_4_1' => 'required|string',
            'answer_7_4_2' => 'required|string',
            'answer_7_4_3' => 'required|string',
            'answer_7_4_4' => 'required|string',
        ];
    }
}
